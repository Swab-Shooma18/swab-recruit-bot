...
const TOP_VOICE_COMMAND = {
  name: "topvoice",
  description: "Shows the weekly top voice channel users in the clan.",
  type: 1 // TYPE 1 = CHAT_INPUT (slash command)
};
...
const ALL_COMMANDS = [TEST_COMMAND, CHALLENGE_COMMAND,LOOKUP_COMMAND,JAD_SKOTIZO_COMMAND,CHECK_COMMAND,ADD_COMMAND,PLAYER_COMMAND,CHECKVOICE_COMMAND,TESTWARFARE_COMMAND,GIVE_BAN_RIGHTS_COMMAND,REMOVE_BAN_RIGHTS_COMMAND,TOP_KILLERS_COMMAND,WEEKLY_TOP_COMMAND,RESET_WEEKLY_COMMAND,TOP_VOICE_COMMAND];
